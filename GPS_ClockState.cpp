...
void GPS_ClockStaeGPSTracing::AppendDisplayMode(int ModeForApp)
{
	ModeForApp = ModeForApp + CurrentDisplayMode;

	if (ModeForApp < GPSTracingDisplayMode::SateliteCount) CurrentDisplayMode = GPSTracingDisplayMode::SateliteCount;
	else if (ModeForApp > GPSTracingDisplayMode::longitude) CurrentDisplayMode = GPSTracingDisplayMode::longitude;
	else CurrentDisplayMode = (GPSTracingDisplayMode::Value)ModeForApp;
}